...
export function Layout({ children }: { children: ReactNode }) {
  ...
  const navItems = [
    ...
    },
    {
      path: '/sdks',
      label: 'SDK X-Ray',
      match: (p: string) => p === '/sdks',
      icon: (
        <svg className="w-[18px] h-[18px]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 6.087c0-.355.186-.676.401-.959.221-.29.349-.634.349-1.003 0-1.036-1.007-1.875-2.25-1.875s-2.25.84-2.25 1.875c0 .369.128.713.349 1.003.215.283.401.604.401.959v0a.64.64 0 0 1-.657.643 48.4 48.4 0 0 1-4.163-.3 1.5 1.5 0 0 0-1.657 1.652c.1.85.199 1.7.3 2.548a.643.643 0 0 0 .642.657v0c.355 0 .676-.186.959-.401.29-.221.634-.349 1.003-.349 1.035 0 1.875 1.007 1.875 2.25s-.84 2.25-1.875 2.25c-.369 0-.713-.128-1.003-.349-.283-.215-.604-.401-.959-.401v0a.643.643 0 0 0-.642.657c.1.85.199 1.7.3 2.548a1.5 1.5 0 0 0 1.657 1.652c1.38-.162 2.77-.262 4.163-.3a.64.64 0 0 0 .657-.643v0c0-.355-.186-.676-.401-.959a1.647 1.647 0 0 1-.349-1.003c0-1.035 1.007-1.875 2.25-1.875s2.25.84 2.25 1.875c0 .369-.128.713-.349 1.003-.215.283-.4.604-.4.959v0c0 .333.277.599.61.58a48.1 48.1 0 0 0 5.427-.63 1.5 1.5 0 0 0 1.185-1.469V6.911a1.5 1.5 0 0 0-1.185-1.47 48.099 48.099 0 0 0-5.427-.629.588.588 0 0 0-.61.58v0Z" />
        </svg>
      ),
    },
    {
